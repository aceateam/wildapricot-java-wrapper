...
public class Contact {
    ...
    public Contact setProfileLastUpdated(Date profileLastUpdated) {
        this.profileLastUpdated = profileLastUpdated;
        return this;
    }

    public Contact setMembershipLevel(MembershipLevel membershipLevel) {
        this.membershipLevel = membershipLevel;
        return this;
    }

    public Contact setMembershipEnabled(Boolean membershipEnabled) {
    ...
    public Contact setAccountAdministrator(Boolean accountAdministrator) {
        isAccountAdministrator = accountAdministrator;
        return this;
    }

    public Contact setTermsOfUseAccepted(Boolean termsOfUseAccepted) {
        this.termsOfUseAccepted = termsOfUseAccepted;
        return this;
    }

    public Contact setContactFieldValues(List<ContactFieldValue> contactFieldValues) {
